...
if (isset($_POST['save_data'])) {
    ...
    if ($bill_no !== '' && $total_amount !== '' && $paid_amount !== '' && $party_id!=='' && $date!=='') {
			...
			if($paid_amount > $total_amount){
				 ...
				 echo '<script>alert("Paid amount should be less than total amount entered")</script>';
				 
			}else{
				$cont_query = $DBcon->query(
						"INSERT INTO tbl_cloth_billing(party_id,bill_no,total_amount,paid_amount,date,status, flag)
									VALUES('$party_id','$bill_no','$total_amount','$paid_amount','$date', '0','0')"
					);
                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="full graph_head">
                                 <div class="heading1 margin_0">
                                    <h2>Add Purchase<small>( cloth )</small></h2>
                                 </div>
                              </div>
						  ...
						  <form action="" method="POST" name="add_bill" onsubmit="return validateForm()">
							...
							<div class="row">
							  ...
							  <div class="col-75">
								...
								<input type="text" value=""  name="bill_no" placeholder="Bill Number">  
							...
							<div class="row">
							  ...
							  <div class="col-75">
								...
								<input type="text" value=""  name="total_amount" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Total Amount">  
							...
							<div class="row">
							  ...
							  <div class="col-75">
								...
								<input type="text" value=""  name="paid_amount" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Paid Amount">  
